...
class BfwEnv(gym.Env):  
    ...
    def _calculate_stats(self):
        ...
        for i in range(2):
            ...
            self.last_run_stats[i].gold = player_history[len(player_history) - 1].gold
        ...
        if self.map_variations > 0:
            if self.map_rotation > 0:
                if self.reset_count % self.map_variations == 0:
                    ...
                    self._copy_file(self.wesnoth_userdata_path + "/data/add-ons/PythonAddon/maps/test_mini" + str(map_index) + ".map", self.wesnoth_userdata_path + "/data/add-ons/PythonAddon/maps/test_mini.map")
                return
    ...
    def _write_map_to_file(self):
        ...
        self._write_line_to_file(self.wesnoth_userdata_path + "/data/add-ons/PythonAddon/maps/test_mini.map", map_string)
